      ...
      <nav className="space-y-1">
        ...
        {profile?.is_owner && (
          <>
            ...
            <Link href="/admin/spaces" className="block rounded-lg px-3 py-2 text-sm hover:bg-muted">
              🗂 Spaces
            </Link>
            <Link href="/admin/tiers" className="block rounded-lg px-3 py-2 text-sm hover:bg-muted">
              💳 Tiers
            </Link>
          </>
        )}
